...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi api) {
    ...
    {
      const BasicMessageChannel<Object> channel =
          BasicMessageChannel<Object>('dev.flutter.pigeon.VideoPlayerApi.setPreferredQuality', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setPreferredQuality was null. Expected QualityMessage.');
          final QualityMessage input = QualityMessage.decode(message);
          api.setPreferredQuality(input);
          return <Object, Object>{};
        });
      }
    }
