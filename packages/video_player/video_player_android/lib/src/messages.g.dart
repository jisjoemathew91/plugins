...
class BufferMessage {
  ...
  Object encode() {
    ...
    pigeonMap['backBufferDurationMs'] = backBufferDurationMs;
    pigeonMap['retainBackBufferFromKeyframe'] = retainBackBufferFromKeyframe;
    return pigeonMap;
  }
  ...
  static BufferMessage decode(Object message) {
    ...
    return BufferMessage(
      ...
      backBufferDurationMs: pigeonMap['backBufferDurationMs'] as int?,
      retainBackBufferFromKeyframe: pigeonMap['retainBackBufferFromKeyframe'] as bool?,
    );
  }
}
...
class AndroidVideoPlayerApi {
  ...
  Future<void> setPreferredQuality(QualityMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AndroidVideoPlayerApi.setPreferredQuality', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_msg]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
